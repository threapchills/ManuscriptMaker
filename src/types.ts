...
export type GameRole = 'scenery' | 'player' | 'solid' | 'platform' | 'goal';
export interface ImageLayer extends BaseLayer { type: 'image'; src: string; assetId?: string; gameRole?: GameRole; imageFit?: 'contain' | 'fill'; }
